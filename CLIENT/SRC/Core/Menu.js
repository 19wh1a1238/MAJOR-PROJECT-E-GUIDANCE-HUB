        ...
        <Toolbar>
          ...
          <Fragment>
            ...
            <Link style={isActive(history, "/shop")} to="/shop">
              <IconButton aria-label="Shop" color="inherit">
                <StorefrontIcon />
                <Typography noWrap>Colleges</Typography>
              </IconButton>
            </Link>
            ...
            {isAuthenticated() && (
              // <Link
              // style={isActive(history, '/user/chat-bot')}
              // to='/user/chat-bot'
              // >
              <a
              ...
              >
                <IconButton aria-label="Chat-Bot" color="inherit">
                  <ChatIcon />
                  <Typography noWrap>Chat-Bot</Typography>
                </IconButton>
              </a>
              // </Link>
            )}
