...
import { prices, departments } from './fixedPrices';
import Copyright from './Copyright';

const Shop = () => {
  const [myFilters, setMyFilters] = useState({
    filters: { category: [], price: [], department: [] },
  });
  ...
  const handleFilters = (filters, filterBy) => {
    ...
    if (filterBy === 'department') {
      let departmentValues = handleDepartments(filters);
      console.log(departmentValues)
      newFilters.filters[filterBy] = departmentValues;
    }
  ...
  return (
    <Layout
      title='Search page'
      description='Search and find Colleges'
